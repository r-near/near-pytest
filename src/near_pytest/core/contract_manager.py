    ...
    def compile_contract(self, contract_path: Union[str, Path]) -> Path:
        ...
        try:
            ...
            if importlib.util.find_spec("nearc") is None:
                raise ContractError("nearc package not found. Please install it with 'pip install nearc'")
            ...
            success = nearc_compile(contract_path, output_path, venv_path, assets_dir, False)
            ...
            try:
                ...
                raise ContractError("nearc command not found. Please install it with 'pip install nearc'")
