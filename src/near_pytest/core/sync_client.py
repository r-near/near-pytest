...
class SyncNearClient:
    ...
    def _create_py_near_account(self, account_id, private_key=None):
        ...
        try:
            ...
            # Create the account
            account = Account(account_id, bytes(private_key), provider_url=self.endpoint)
    ...
    def call_function(self, sender_id, contract_id, method_name, args=None, amount=0, gas=None):
        """
